...
public class KE_Orc : MonoBehaviour
{
    // - 경과시간
    float currentTime;
    ...
    EnemyState1 myState = EnemyState1.Idle;
    ...
    void Update()
    {
        ...
        switch (myState)
        {
            case EnemyState1.Idle:
                Idle();
                break;
            case EnemyState1.Move:
                Move();
                break;
            case EnemyState1.Attack:
                Attack();
                break;
            case EnemyState1.Damage:
                Damage();
                break;
            case EnemyState1.Die:
                Die();
                break;
            case EnemyState1.RealDeath:
                RealDeath();
                break;
        }
