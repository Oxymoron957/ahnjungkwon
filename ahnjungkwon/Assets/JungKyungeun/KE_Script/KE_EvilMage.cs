...
public class KE_EvilMage : MonoBehaviour
{
    // - 경과시간
    float currentTime;
    ...
    EnemyState7 myState = EnemyState7.Idle;
    ...
    void Update()
    {
        ...
        switch (myState)
        {
            case EnemyState7.Idle:
                Idle();
                break;
            case EnemyState7.Move:
                Move();
                break;
            case EnemyState7.Attack:
                Attack();
                break;
            case EnemyState7.Damage:
                Damage();
                break;
            case EnemyState7.Die:
                Die();
                break;
            case EnemyState7.RealDeath:
                RealDeath();
                break;
        }
