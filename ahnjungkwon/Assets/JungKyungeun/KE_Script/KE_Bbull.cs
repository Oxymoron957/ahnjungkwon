...
public class KE_Bbull : MonoBehaviour
{
    // - 경과시간
    float currentTime;
    ...
    EnemyState3 myState = EnemyState3.Idle;
    ...
    void Update()
    {
        ...
        switch (myState)
        {
            ...
            case EnemyState3.Damage:
                Damage();
                break;
            case EnemyState3.Die:
                Die();
                break;
            case EnemyState3.RealDeath:
                RealDeath();
                break;
        }
